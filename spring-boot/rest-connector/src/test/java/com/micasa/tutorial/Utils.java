...
public class Utils {
    ...
    public static ProcessInstanceEvent startProcess(ZeebeClient client, String processId, Map<String, Object> variables) {
    ...
    public static ProcessInstanceEvent startProcessBefore(ZeebeClient client, String processId, String startingPointId, Map<String, Object> variables) {
        ProcessInstanceEvent processInstance = client.newCreateInstanceCommand()
                .bpmnProcessId(processId)
                .latestVersion()
                .variables(variables)
